...
Nous disposons déjà d'une \textbf{implémentation fonctionnelle} de la génération de clé \textbf{RSA 2048 bits}. En voici un exemple simplifié d'exécution :

\begin{lstlisting}[language=Rust, title={\texttt{test.rs}}, style=custom]
use nexium::rsa;
...
\begin{lstlisting}[title={\texttt{test.rs:} \textbf{Output}}, style=custom]
[test.rs:5:5] 
  keypair = {
    n: <xxxx>
    d: <xxxx>
...
Nous aborderons ultérieurement dans le développement du projet le système de \textbf{signatures} et de \textbf{vérification} de messages, tout autant essentiels à Nexium.
