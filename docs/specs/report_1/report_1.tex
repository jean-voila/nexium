...
\begin{lstlisting}[language=Rust, title={test.rs}, style=custom]
use nexium::rsa;
...
\begin{lstlisting}[title={test.rs: Output}, style=custom]
[src/bin/server/main.rs:20:5] 
  keypair = {
    n: <xxxx>
    d: <xxxx>
    p: <xxxx>
...
\begin{lstlisting}[style=custom, caption={blockchain.md}]
---
