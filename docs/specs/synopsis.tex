...
\begin{itemize}
    \item \textbf{Création de Comptes} : Les étudiants d'Épita pourraient créer un compte Nexium en fournissant leur adresse d'étudiant. Après avoir généré une paire de clés, ils auront à copier la clé publique renvoiée par le programme sur l'interface du \href{https://gitlab.cri.epita.fr}{Gitlab} de l'école, dans le champ des clés GPG . Il s'agira d'une \hyperref[def:cle-rsa]{\textbf{clé RSA}} de 2048 bits. \
