...
\title{
  \textbf{Nexium} \\
  \large Un micro-système économique décentralisé pour étudiants \\
...
\begin{itemize}
    \item \texttt{Login}: une chaîne de caractères représentant le login Epita de l'utilisateur (prenom.nom). La vérification du format de la chaîne sera faite à partir d'une expression régulière.
...
\begin{itemize}
    ...
    \item \texttt{id\_hash} un hash du bloc, permettant de l'identifier de manière unique. Cet identifiant sera incrémental. (type: \texttt{Hash})
