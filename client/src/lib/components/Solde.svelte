...
<div class="relative w-80 h-80">
    ...
    <div class="absolute inset-0 rounded-full top-1/2 left-1/2 w-60 h-60 transform -translate-x-1/2 -translate-y-1/2 bg-black"></div>
    <div class="absolute inset-0 rounded-full cercle-gris border-19"></div>
