            ...
            {:else}
                ...
                <div class="grid grid-cols-2 gap-4">
                    {#if topRecipients.length > 0}
                        <div class="card">
                            <h4
                                class="flex items-center gap-2 text-sm font-semibold text-muted mb-3"
                            >
                                <TrendingUp size={14} /> Top destinataires
                            </h4>
                            {#each topRecipients as recipient, i}
                                <div
                                    class="flex items-center gap-3 py-2 border-b border-glass-border last:border-0"
                                >
                                    <span class="text-muted text-sm w-6">#{i + 1}</span>
                                    <span class="font-mono text-sm flex-1">{recipient.login}</span>
                                    <span class="text-sm font-medium"
                                        >{formatAmount(recipient.total)}</span
                                    >
                        ...
                        <div class="card">
                            ...
                            {#each topSenders as sender, i}
                                ...
                                >
                                    ...
                                    <span class="text-sm font-medium"
                                        >{formatAmount(sender.total)}</span
                                    >
