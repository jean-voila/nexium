...
check(https://blog.boot.dev/cryptography/how-sha-2-works-step-by-step-sha-256/) for clear steps
        ...
        -Append the 64 bits we left empty at the step before where the 64 are bigendian integer representing the lenght of the original input in binary
